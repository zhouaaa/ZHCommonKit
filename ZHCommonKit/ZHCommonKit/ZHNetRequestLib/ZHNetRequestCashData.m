...
@interface ZHNetRequestCashData()
...
@implementation ZHNetRequestCashData

static ZHNetRequestCashData *cashData = nil;

+ (ZHNetRequestCashData *)shareManager{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        cashData = [[ZHNetRequestCashData alloc] init];
    });
...
-(NSString*)getFullFilePathByUrlString:(NSString*)urlString{
    ...
    NSString *fileName =[urlString stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]];
